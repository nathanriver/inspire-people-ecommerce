  ...
  return (
    <AdminLayout>
      {error ? (
        ...
        <>
          <nav className="bg-grey-light rounded font-sans w-full mb-3">
          ...
          {category.is_one_size ? (
            <p>This category only have one size.</p>
          ) : (
            <>
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-1">
                          ...
                          <ConfirmationModal
                            ...
                            action={() =>
                              handleDeleteProductSize(productSize.id)
                            }
                          />
                        </div>
                      </TableCell>
